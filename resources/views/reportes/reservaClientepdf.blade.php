...
<body>
    <div class="container">
      <h3 class="text-center">Reporte de reservas de {{$cliente->nombre}} {{$cliente->apellido}} </h3>  
    </div>
            ...
            {{-- <div class="row">
                <h5 class=" col-2 bg-success text-white shadow-lg"> Ganancia estimada: </h5>  
                <h5 class="col-2"> S/. {{$gananciaDia}}</h5>
            </div> --}}
