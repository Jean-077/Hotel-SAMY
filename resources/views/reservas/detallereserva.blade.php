...
<br>
<div class="container">
    <a href="{{route('correos.ReservaMail',$reserva->idHabitacion)}}" class="btn btn-primary">Enviar correo</a>
    <a href="{{route('reportes.verreservacionpdf',$reserva->idHabitacion)}}" class="btn btn-primary">Guardar PDF</a>
</div>
